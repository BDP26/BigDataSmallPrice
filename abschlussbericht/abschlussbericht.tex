...
\textbf{Datenmenge (Volume):} Der Winterthurer Lastgang umfasst 13~Jahre
an 15-Minuten-Daten (rund 462\,000~Eintr\"age), ENTSO-E-Preisdaten gehen
bis 2015 zur\"uck.
TimescaleDB partitioniert Zeitreihen automatisch in Zeitbl\"ocke und
skaliert damit auf Milliarden von Eintr\"agen.

\textbf{Aktualit\"at (Velocity):} Die Pipeline l\"auft t\"aglich vollautomatisch.
Ein~15-Minuten-Cache im Frontend reduziert die Datenbankbelastung
bei vielen gleichzeitigen Nutzern um rund~97\,\%.

\textbf{Datenvielfalt (Variety):} Das System verarbeitet sechs Datenformate
(XML, JSON, CSV, Parquet, SQL, Modell-Dateien) von acht Quellen mit
verschiedenen zeitlichen Aufl\"osungen.

\textbf{Parallelisierung:} Die ETL-Pipeline f\"uhrt bis zu~14 Aufgaben
gleichzeitig aus; XGBoost nutzt alle CPU-Kerne; die neuronalen Netze
k\"onnen optional auf einer NVIDIA~RTX~3080~GPU trainiert werden.
