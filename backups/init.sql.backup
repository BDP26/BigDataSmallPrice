...
-- ─── 10e. Feature View: training_features (Model B – EPEX Day-Ahead) ──────────
-- Target: price_eur_mwh
-- Design decisions:
--   - No Groupe E / CKW: EPEX transformations → near-leakage + limit window to 3 months.
--   - No BAFU: single river gauge, negligible signal for EU-wide market pricing.
--   - ENTSO-E actual data used ONLY as lag features (lag_24h / lag_168h).
...
SELECT
  ...
  -- Load forecast (day-ahead, valid for D+1 use only)
